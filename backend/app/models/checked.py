...
class Checked(BaseModel, TimestampMixin):
    ...
    material = fields.ForeignKeyField(
        "models.Material",
        related_name="checked_material")
    number = fields.IntField(description="送检数量")
    toCheckUser = fields.ForeignKeyField(
        'models.User', related_name='checked_user')
    ...
    toReturnUser = fields.ForeignKeyField(
        'models.User', related_name='return_user', null=True)
