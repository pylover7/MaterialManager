...
class User(BaseModel, TimestampMixin, UUIDModel):
    ...
    roles: fields.ManyToManyRelation["Role"] = fields.ManyToManyField(
        "models.Role", related_name="user_roles")
...
class Role(BaseModel, TimestampMixin):
    ...
    menus: fields.ManyToManyRelation["Menu"] = fields.ManyToManyField(
        "models.Menu", related_name="roles")
    apis: fields.ManyToManyRelation["Api"] = fields.ManyToManyField(
        "models.Api", related_name="roles")
    users: fields.ManyToManyRelation["User"]
    areas: fields.ManyToManyRelation["MaterialArea"] = fields.ManyToManyField(
        "models.MaterialArea", related_name="roles")
...
class Menu(BaseModel, TimestampMixin):
    ...
    icon = fields.CharField(
        ...
        blank=True,
        description="菜单图标")
    extraIcon = fields.CharField(
        max_length=100,
        null=True,
        blank=True,
        description="右侧图标")
    transitionName = fields.CharField(
        max_length=100,
        null=True,
        blank=True,
        description="当前页面动画")
    enterTransition = fields.CharField(
        max_length=100,
        null=True,
        blank=True,
        description="进入动画")
    leaveTransition = fields.CharField(
        max_length=100,
        null=True,
        blank=True,
        description="离开动画")
